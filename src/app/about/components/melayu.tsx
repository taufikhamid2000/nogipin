    ...
    <div className="bg-gray-800 p-6 rounded-lg shadow-xl">
      ...
      <p className="text-gray-300 mb-4">
        <strong>
          ...
          penting, tetapi nombor giliran anda hanya dipanggil selepas beberapa
          jam menunggu?
        </strong>
      </p>
      ...
      <ul className="list-disc pl-5 text-gray-300 space-y-2">
        ...
        <li>
          ✅ <strong>Ketelusan dalam status giliran</strong> – Pengguna boleh
          melihat jumlah individu dalam barisan sebelum mereka.
        </li>
        <li>
